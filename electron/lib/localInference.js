...
function fetchJson(url) {
    return new Promise((resolve, reject) => {
        https.get(url, { headers: { 'User-Agent': 'sideai' } }, (res) => {
...
function downloadFile(url, destPath, onProgress) {
    ...
    const attempt = (requestUrl, redirectsLeft, retriesLeft) => new Promise((resolve, reject) => {
        ...
        const reqHeaders = {
            'User-Agent': 'Mozilla/5.0 (compatible; sideai/1.0)',
            'Accept': '*/*',
...
const CUSTOM_BINARIES = {
    'darwin-arm64': 'https://raw.githubusercontent.com/huytue3107/SideAI-generative/main/binaries/sd-cli-metal-macos-arm64.zip',
};
